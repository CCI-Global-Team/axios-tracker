...
// CCI: upstream pointed these at plane.so's own legal pages, which told every volunteer at the
// moment they signed in that Plane Software, Inc.'s terms governed their relationship with CCI.
// These are CCI's own published policies.
const LEGAL_LINKS = {
  termsOfService: "https://joincci.org/terms-of-service",
  privacyPolicy: "https://joincci.org/privacy-policy",
} as const;
