    ...
    <div className="m-6 mb-4 flex flex-shrink-0 items-center justify-between gap-4">
      <div className="flex items-center gap-2">
        ...
        <a
          ...
          href="https://github.com/CCI-Global-Team/axios-tracker/releases"
          target="_blank"
          className="text-13 text-secondary underline-offset-1 outline-none hover:text-primary hover:underline"
          rel="noreferrer"
        >
      ...
      {/* CCI: upstream linked out to plane.so/pages, promoting Plane's own paid
          "Pages" product. Axios has no equivalent to advertise, so the promo is
          dropped rather than rebranded. */}
    </div>
  );
}
